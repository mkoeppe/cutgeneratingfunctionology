...
def plot_figure_3():
    ...
    deco = line([(1/5, 3/5), (1/5, 1+3/10*h(1/5))], color='cyan', thickness=2, zorder=-1)+line([(1/5, 3/5), (-3/10*h(3/5), 3/5)], color='cyan', thickness=2, zorder=-1)+ line([(1/5, 3/5), (4/5, 0)], color='cyan', thickness=2, zorder=-1)+line([(4/5, 0), (4/5, 1+3/10)], color='cyan', thickness=2, zorder=-1)+text("$\Delta\pi(x,y)$", (1/5, 3/5), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='left', color='black', fontsize=15)+text("$\pi(x)$", (1/5, 1+3/10*h(1/5)+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='center', color='black', fontsize=15)+text("$\pi(y)$", (-3/10*h(3/5)-0.02, 3/5), axis_coords=False, vertical_alignment='center', horizontal_alignment='right', color='black', fontsize=15)+text("$\pi(x+y)$", (4/5, 1+3/10+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='center', color='black', fontsize=15)
