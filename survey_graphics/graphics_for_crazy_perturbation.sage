...
sage: g.show(figsize=4, show_legend=False)
sage: g.save("zhou_two_sided_discontinuous_cannot_assume_any_continuity-covered_intervals.png", figsize=4, show_legend=False)
sage: extremality_test(h)
INFO: 2016-04-18 03:27:22,579 Finding epsilon interval for perturbation... done.  Interval is [-4/9, 4/3]
sage: pert = h._perturbations[0] * 4/9

sage: def black_rainbow(num):
....:         return ['black', 'black', 'black'][:num]
....: 
sage: igp.rainbow = black_rainbow
sage: g = plot(pert, color='magenta')
sage: g += plot(h+pert, color='blue')
sage: g += plot(h-pert, color='red')
sage: g += plot_covered_intervals(h)
sage: g.show(figsize=4, show_legend=False)
sage: g.save("zhou_two_sided_discontinuous_cannot_assume_any_continuity-perturbation-1.png", figsize=4, show_legend=False)
...
sage: gcrazy = plot_with_colored_slopes(hlift)
sage: gcrazy.show(aspect_ratio=1/4, figsize=10, show_legend=False, gridlines=None)
...
sage: (gcrazy+plot(cp*0.1)).save('has_crazy_perturbation.png', aspect_ratio=1/4, figsize=10, show_legend=False, gridlines=False, ticks=[[],[]], tick_formatter=[[],[]])
...
### right-angle ####
sage: u = 0; v = 0; eta = 1; delta = 0.25;
sage: face = Face(([u,u+eta],[v,v+eta],[u+v,u+v+2*eta]))
sage: t1 = 0.05; t2 = 0.2
sage: x1 = u+t1; x2 = u+t2
sage: y1 = v + delta;
sage: y2 = y1 + (t2 - t1)
sage: y3 = y2 + (t2 - t1)
sage: yn1 = y3 + delta
sage: yn = yn1 + (t2 - t1)
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += disk((u,v), 0.1, (0, pi/2), color="mediumspringgreen", zorder=-5)
sage: g += line([(x1, y2), (x2, y1)], color='black', linestyle=':') + line([(x1, y3), (x2, y2)], color='black', linestyle=':') +line([(x1, yn), (x2, yn1)], color='black', linestyle=':')
sage: g += line([(0, y1), (x2, y1)], color='black', linestyle=':')+line([(0, y2), (x2, y2)], color='black', linestyle=':')+line([(0, y3), (x2, y3)], color='black', linestyle=':')+line([(0, yn1), (x2, yn1)], color='black', linestyle=':')+line([(0, yn), (x2, yn)], color='black', linestyle=':')+line([(x1, 0), (x1, yn)], color='black', linestyle=':')+line([(x2, 0), (x2, yn)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y2),(x2,y1),(x1,y3),(x2,y2),(x1,yn),(x2,yn1)], color='black',size=30,zorder=10)
sage: ticks = [[u, x1, x2, u+delta, u+eta], [v, y1, y2, y3, yn1, yn, v+eta]]
sage: tick_formatter = [["$u$", "$x$", "$x'$", "", "$u+\eta$"],["$v$","$y_1$","$y_2$","$y_3$","$y_{N-1}$","$y_N$","$v+\eta$"]]
sage: g += text("$(u,v)$", (u-0.01,v-0.01), axis_coords=False, vertical_alignment='top', horizontal_alignment='right',color='black',fontsize=20)
g += text("$u+\delta$", (u+delta, -0.01), axis_coords=False, vertical_alignment='top', horizontal_alignment='left',color='black',fontsize=20)
sage: g.fontsize(20)
sage: g.show(ticks=ticks, tick_formatter=tick_formatter)
sage: g.save("proof_uniform_cont_case_1.png", ticks=ticks, tick_formatter=tick_formatter)

### obtuse-angle ####
sage: u = 1.1; v = 0.1; eta = 1; delta = 0.25;
sage: face = Face(([u-eta,u+eta],[v,v+eta],[u+v,u+v+2*eta]))
sage: t1 = -0.1; t2 = 0.05
sage: x1 = u+t1; x2 = u+t2
sage: y1 = v + delta;
sage: y2 = y1 + (t2 - t1)
...
sage: yn = yn1 + (t2 - t1)
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v+eta)], color='black')+line([(u,v), (u+eta, v)], color='black')
sage: g += disk((u,v), 0.1, (0, pi*3/4), color="mediumspringgreen", zorder=-5)
sage: g += line([(x1, y2), (x2, y1)], color='black', linestyle=':') + line([(x1, y3), (x2, y2)], color='black', linestyle=':') +line([(x1, yn), (x2, yn1)], color='black', linestyle=':')
sage: g += line([(0, y1), (x2, y1)], color='black', linestyle=':')+line([(0, y2), (x2, y2)], color='black', linestyle=':')+line([(0, y3), (x2, y3)], color='black', linestyle=':')+line([(0, yn1), (x2, yn1)], color='black', linestyle=':')+line([(0, yn), (x2, yn)], color='black', linestyle=':')+line([(x1, 0), (x1, yn)], color='black', linestyle=':')+line([(x2, 0), (x2, yn)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y2),(x2,y1),(x1,y3),(x2,y2),(x1,yn),(x2,yn1)], color='black',size=30,zorder=10)
sage: ticks = [[u, x1, x2, u-delta, u-eta, u+delta, u+eta], [v, y1, y2, y3, yn1, yn, v+eta]]
sage: tick_formatter = [["$u$", "$x$", "", "", "$u-\eta$", "", "$u+\eta$"],["$v$","$y_1$","$y_2$","$y_3$","$y_{N-1}$","$y_N$","$v+\eta$"]]
sage: g += text("$(u,v)$", (u-0.02,v), axis_coords=False, vertical_alignment='center', horizontal_alignment='right',color='black',fontsize=20)
...
sage: g.fontsize(20)
sage: g.show(ticks=ticks, tick_formatter=tick_formatter)
sage: g.save("proof_uniform_cont_case_2.png", ticks=ticks, tick_formatter=tick_formatter)

### sharp-angle ####
sage: u = 1; v = 0.1; eta = 1; delta = 0.25;
sage: face = Face(([u-eta,u],[v,v+eta],[u+v,u+v+eta]))
sage: t1 = -0.2; t2 = -0.05
sage: x1 = u+t1; x2 = u+t2
sage: y1 = v + delta;
sage: y2 = y1 + (t2 - t1)
...
sage: yn = yn1 + (t2 - t1)
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v+eta)], color='black')+line([(u,v), (u, v+eta)], color='black')
sage: g += disk((u,v), 0.1, (pi/2, pi*3/4), color="mediumspringgreen", zorder=-5)
sage: g += line([(x1, y2), (x2, y1)], color='black', linestyle=':') + line([(x1, y3), (x2, y2)], color='black', linestyle=':') +line([(x1, yn), (x2, yn1)], color='black', linestyle=':')
sage: g += line([(0, y1), (x2, y1)], color='black', linestyle=':')+line([(0, y2), (x2, y2)], color='black', linestyle=':')+line([(0, y3), (x2, y3)], color='black', linestyle=':')+line([(0, yn1), (x2, yn1)], color='black', linestyle=':')+line([(0, yn), (x2, yn)], color='black', linestyle=':')+line([(x1, 0), (x1, yn)], color='black', linestyle=':')+line([(x2, 0), (x2, yn)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y2),(x2,y1),(x1,y3),(x2,y2),(x1,yn),(x2,yn1)], color='black',size=30,zorder=10)
sage: ticks = [[u, x1, x2, u-delta, u-eta], [v, y1, y2, y3, yn1, yn, v+eta]]
sage: tick_formatter = [["$u$", "$x$", "$x'$", "", "$u-\eta$"],["$v$","$y_1$","$y_2$","$y_3$","$y_{N-1}$","$y_N$","$v+\eta$"]]
#sage: g += text("$v$", (-0.01,v), axis_coords=False, vertical_alignment='center', horizontal_alignment='right',color='black',fontsize=20)
sage: g += text("$(u,v)$", (u,v), axis_coords=False, vertical_alignment='top', horizontal_alignment='left',color='black',fontsize=20)
g += text("$u-\delta$", (u-delta, -0.01), axis_coords=False, vertical_alignment='top', horizontal_alignment='right',color='black',fontsize=20)
sage: g.fontsize(20)
sage: g.show(ticks=ticks, tick_formatter=tick_formatter)
sage: g.save("proof_uniform_cont_case_3.png", ticks=ticks, tick_formatter=tick_formatter)

### sharp-angle consider p2 p3 ####
sage: u = 0; v = 0; eta = 1
sage: face = Face(([u,u+eta],[v,v+eta],[u+v,u+v+eta]))
sage: g = face.plot()
sage: g += point([(u+eta,v)], color='black',size=30,zorder=10)
sage: g += text("$(u,v)$", (u+eta,v-0.01), axis_coords=False, vertical_alignment='top', horizontal_alignment='center',color='black',fontsize=20)
sage: g.show(axes=False)
sage: g.save("proof_uniform_cont_case_4.png", axes=False)

### V for case 1 and 2 ####
sage: u = 1.1; v = 0.1; delta = eta = 1;
sage: face = Face(([u-delta,u+delta],[v,v+delta],[u+v,u+v+2*delta]))
sage: t1 = 0.3; t2 = 0.75;
sage: x2 = u+t1; x1 = u+t2;
sage: y1 = v+t1; y2 = v+t2;
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v+eta)], color='black')+line([(u,v), (u+eta, v)], color='black') + line([(u,v), (u, v+eta)], color='black')
sage: g += line([(x1, y1), (x2, y2)], color='black', linestyle=':')
sage: g += line([(0, y1), (x1, y1)], color='black', linestyle=':')+line([(0, y2), (x2, y2)], color='black', linestyle=':')+line([(x1, 0), (x1, y1)], color='black', linestyle=':')+line([(x2, 0), (x2, y2)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y1),(x2,y2)], color='black',size=30,zorder=10)
sage: g += text("$(u,v)$", (u-0.02,v), axis_coords=False, vertical_alignment='center', horizontal_alignment='right',color='black',fontsize=20)
sage: ticks = [[u, x1, x2, u-delta, u+delta], [v, y1, y2, v+delta]]
sage: tick_formatter = [["$u$", "$x$", "$x'$", "$u-\delta$", "$u+\delta$"],["$v$","$y$","$y'$","$v+\delta$"]]
sage: g.fontsize(20)
sage: g.show(ticks=ticks, tick_formatter=tick_formatter)
sage: g.save("proof_uniform_V_case12.png", ticks=ticks, tick_formatter=tick_formatter)

### V for case 3 ####
sage: u = 1.1; v = 0.1; eta = delta = 1;
sage: face = Face(([u-eta,u],[v,v+eta],[u+v-eta,u+v+eta]))
sage: t1 = 0.3; t2 = 0.75
sage: y1 = v + t1; y2 = v+t2
sage: x1 = u - t1/2; x2 = x1+y1-y2
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v+eta)], color='black')+line([(u,v), (u, v+eta)], color='black')+line([(u,v), (u-eta, v)], color='black')
sage: g += line([(x1, y1), (x2, y2)], color='black', linestyle=':')
sage: g += line([(0, y1), (u, y1)], color='black', linestyle=':')+line([(0, y2), (x2, y2)], color='black', linestyle=':')+line([(x1, 0), (x1, y1)], color='black', linestyle=':')+line([(x2, 0), (x2, y2)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y1),(x2,y2)], color='black',size=30,zorder=10)
sage: ticks = [[u, x1, x2, u-delta], [v, y1, y2, v+delta]]
sage: tick_formatter = [["$u$", "$x$", "$x'$","$u-\delta$"],["$v$","$y$","$y'$","$v+\delta$"]]
sage: g += text("$(u,v)$", (u,v), axis_coords=False, vertical_alignment='top', horizontal_alignment='left',color='black',fontsize=20)
sage: g += text("=",(u-t1/4,v+t1+0.01), rotation="vertical", axis_coords=False, vertical_alignment='center', horizontal_alignment='center',color='blue', fontsize=15)+text("=",(u-t1*3/4,v+t1+0.01), rotation="vertical",axis_coords=False, vertical_alignment='center', horizontal_alignment='center',color='blue', fontsize=15)
sage: g.fontsize(20)
sage: g.show(ticks=ticks, tick_formatter=tick_formatter,figsize=5.9)
sage: g.save("proof_uniform_V_case3.png", ticks=ticks, tick_formatter=tick_formatter,figsize=5.9)


### W for case 1 and 2 ####
sage: u = 0; v = 0.5; delta = eta = 1;
sage: face = Face(([u-delta,u+delta],[v,v+delta],[u+v,u+v+2*delta]))
sage: t1 = 0.3; t2 = 0.75;
sage: z1 = u+v+t1; z2 = u+v+t2;
sage: y = v+t1/2
sage: x1 = z1-y; x2 = z2-y;
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v+eta)], color='black')+line([(u,v), (u+eta, v)], color='black') + line([(u,v), (u, v+eta)], color='black')
sage: g += line([(u, y), (x2, y)], color='black', linestyle=':')
sage: g += line([(u, v), (u+v, 0)], color='black', linestyle=':')+line([(u, v+t1), (z1, 0)], color='black', linestyle=':')+line([(x2, y), (z2, 0)], color='black', linestyle=':')+line([(u+delta, v), (u+v+delta, 0)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y),(x2,y)], color='black',size=30,zorder=10) #(u+delta,v),(u, v+delta)
sage: g += text("$(u,v)$", (u-0.02,v), axis_coords=False, vertical_alignment='center', horizontal_alignment='right',color='black',fontsize=20)+text("$(u+\delta,v)$", (u+delta+0.02,v), axis_coords=False, vertical_alignment='center', horizontal_alignment='left',color='black',fontsize=20)+text("$(u,v+\delta)$", (u,v+delta+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='center',color='black',fontsize=20)+text("$(x,y)$", (x1+0.02,y+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='left',color='black',fontsize=20)+text("$(x',y)$", (x2+0.02,y+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='left',color='black',fontsize=20)
sage: g += arrow((0.3,0), (u+v+delta+0.4,0), color='black',width=1)
sage: zticks = [u+v, z1, z2, u+v+delta+0.05]
sage: zlocs = [u+v, z1, z2, u+v+delta]
sage: ztick_formatter = ["$u+v$", "$z$", "$z'$", "$u+v+\delta$"]
...
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v+eta)], color='black')+ line([(u,v), (u, v+eta)], color='black')
sage: g += line([(u, y), (0, y)], color='black', linestyle=':')
sage: g += line([(u, v), (u+v, 0)], color='black', linestyle=':')+line([(x1, y), (z1, 0)], color='black', linestyle=':')+line([(x2, y), (z2, 0)], color='black', linestyle=':')+line([(u, y), (u+v+delta, 0)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y),(x2,y)], color='black',size=30,zorder=10) #(u+delta,v),(u, v+delta)
...
sage: g += text("$y=v+\delta$", (u+0.02,v+delta), axis_coords=False, vertical_alignment='center', horizontal_alignment='left',color='black',fontsize=20)
sage: g += arrow((0.3,0), (u+v+delta+0.4,0), color='black',width=1)
sage: zticks = [u+v, z1, z2, u+v+delta+0.05]
sage: zlocs = [u+v, z1, z2, u+v+delta]
sage: ztick_formatter = ["$u+v$", "$z$", "$z'$", "$u+v+\delta$"]
...
sage: g.fontsize(20)
sage: g.show(axes=False)
sage: g.save("proof_uniform_W_case3a.png",axes=False)
...
sage: x1 = z1-y; x2 = z2-y;
sage: g = face.plot(alpha=0.1, zorder=-10)
sage: g += line([(u,v), (u-eta, v)], color='black')+ line([(u,v), (u, v+eta)], color='black')
sage: g += line([(u-delta, y), (u, y)], color='black', linestyle=':')
sage: g += line([(u, v), (u+v, 0)], color='black', linestyle=':')+line([(x1, y), (z1, 0)], color='black', linestyle=':')+line([(x2, y), (z2, 0)], color='black', linestyle=':')+line([(u, y), (u+y, 0)], color='black', linestyle=':')+line([(u-delta, y), (u-delta+y, 0)], color='black', linestyle=':')
sage: g += point([(u,v),(x1,y),(x2,y)], color='black',size=30,zorder=10) #(u+delta,v),(u, v+delta)
sage: g += text("$(u,v)$", (u-0.02,v), axis_coords=False, vertical_alignment='center', horizontal_alignment='right',color='black',fontsize=20)+text("$(x,y)$", (x1,y+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='center',color='black',fontsize=20)+text("$(x',y)$", (x2,y+0.02), axis_coords=False, vertical_alignment='bottom', horizontal_alignment='center',color='black',fontsize=20)
sage: g += text("$y=v+\frac{\delta}{2}$", (u+0.02,y), axis_coords=False, vertical_alignment='center', horizontal_alignment='left',color='black',fontsize=20)
sage: g += arrow((0.3,0), (u+y+0.4,0), color='black',width=1)
sage: zticks = [u+v, z1, z2, u+y+0.05]
sage: zlocs = [u+v, z1, z2, u+v+y]
sage: ztick_formatter = ["$u+v$", "$z$", "$z'$", "$u+v+\frac{\delta}{2}$"]
sage: for i in range(4):
....:     g += text(ztick_formatter[i], (zticks[i], -0.01), axis_coords=False, vertical_alignment='top', horizontal_alignment='center',color='black',fontsize=20)
....:     g += line([(zlocs[i],0),(zlocs[i],0.03)],color='black',thickness=0.5)
sage: g.fontsize(20)
sage: g.show(axes=False)
sage: g.save("proof_uniform_W_case3b.png",axes=False)
