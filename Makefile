...
check-encoding:
	@if LC_ALL=C grep -v -n '^[ -~∪]*$$' $(SAGEFILES) ; then echo "Offending characters found."; exit 1; else echo "All Sage files are ASCII (or select unicode) and have no tabs. Good."; exit 0; fi
