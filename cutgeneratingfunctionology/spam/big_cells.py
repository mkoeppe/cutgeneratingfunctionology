r"""
Utilities for programming with big cells
"""
...
def _common_parametric_real_field(iterable, key=None):
    ...
    EXAMPLES::
        ...
        sage: from cutgeneratingfunctionology.spam.big_cells import _common_parametric_real_field
...
def min(iterable, key=None, field=None):
    """
    ...
    with field.off_the_record():
        min_i, min_v = builtins.min(iv_list, key=lambda iv: iv[1])
