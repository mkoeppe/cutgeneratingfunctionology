...
##     print "####### Seed ", seed, "######"
##     try:
##         stab_int, walk_dict = find_stability_interval_with_deterministic_walk_list(seed, generate_uncovered_intervals(h), generate_moves(h), h, max_num_it=50000)
##         print "Length: ", len(walk_dict)
##     except MaximumNumberOfIterationsReached:
##         print "Exceeded iteration limit"

## if minimality_test(h):
##     try_bfs(19/60)                             # contradiction of signs
