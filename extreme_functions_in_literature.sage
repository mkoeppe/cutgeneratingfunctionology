...
def psi_gj_conjecture_counterexample(f=2/3, q=4, eta=1/1000, maxiter=10000):
    """
    ...
    Examples:
        quick evaluations::
            sage: psi_gj_conjecture_counterexample(f=2/3, q=4, eta=0, maxiter=10000)(r=1/5)
            sage: psi_gj_conjecture_counterexample(f=2/3, q=4, eta=0, maxiter=10000)(r=1/4)

        too many iterations::
            sage: psi_gj_conjecture_counterexample(f=2/3, q=4, eta=0, maxiter=10000)(r=9/40)
...
def psi_n_in_gj_conjecture_counterexample_construction(f=2/3, e=[1/12, 1/24]):
    ...
    Examples:
        [IR1]  p.30, fig.1::
            ...
            sage: h = psi_n_in_gj_conjecture_counterexample_construction(f=4/5, e=generate_example_e_for_psi_n(f=4/5, n=7, q=3, eta=0))
